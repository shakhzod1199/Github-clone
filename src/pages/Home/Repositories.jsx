...
const repositories = () => {
    ...
    const Lang = TypeRepo.filter(e => {
        return langs != ' ' ? e.language.toLowerCase().includes(langs.toLowerCase()) : '';
    })
                        ...
                        <div className="drpFilter d-flex gap-2">
                            <div className="dropdown type">
                                ...
                                <ul className="dropdown-menu border" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li value='' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >All</li>
                                    <li value='public' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Public</li>
                                    <li value='private' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Private</li>
                                    <li value='sources' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Sources</li>
                                    <li value='forks' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Forks</li>
                                    <li value='archived' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Archived</li>
                                    <li value='mirrors' className="dropdown-item border-bottom" onClick={(e) => setType(e.target.getAttribute('value'))} >Mirrors</li>
                                    <li value='templates' className="dropdown-item" onClick={(e) => setType(e.target.getAttribute('value'))} >Templates</li>
                                </ul>
                            </div>
                            <div className="dropdown lang">
                                ...
                                <ul className="dropdown-menu border select" aria-labelledby="dropdownMenuButton" >
                                    ...
                                    <li value='' selected className="dropdown-item border-bottom" onClick={(e) => setLangs(e.target.getAttribute('value'))}>All</li>
                                    <li value='javascript' className="dropdown-item border-bottom" onClick={(e) => setLangs(e.target.getAttribute('value'))}>JavaScript</li>
                                    <li value='css' className="dropdown-item" onClick={(e) => setLangs(e.target.getAttribute('value'))}>Css</li>
                                </ul>
                            </div>
